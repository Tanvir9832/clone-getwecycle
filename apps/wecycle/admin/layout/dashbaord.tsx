...
import { Layout, Menu, Button, MenuProps, Modal } from "@tanbel/react-ui";
import { Space } from "@tanbel/react-ui";
import { useRouter } from "next/router";
import { useAppState } from "../store/appState";
import AuthBanner from "../assets/logo.png";
    ...
    <Layout style={{ minHeight: "100vh" }}>
      <div className="h-[60px] bg-white flex items-center justify-between border-b px-6">
        <div className="flex items-center">
          ...
          />
          <Space width={10} />
          <Image alt="logo" src={AuthBanner} className="w-[60%]" />
        </div>
